...
public class ShowMyData extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            cursor.moveToFirst();  //웹과다르게 이건 raw로 바로 들어감 (웹은 필드쪽에서 시작)
        ...
        public void nextData(View v) {
            ...
            if (cursor.getCount() > 0 && nowData <= numburOfData) {
                ...
                cursor.moveToPosition(nowData - 1); //원하는 레코드 번호로 이동
    ...
    public void deleteData(View v) {
        ...
        if (numburOfData >= 1)
            try {
                ...
                diary_content = cursor.getString(0);
                nowData -= 1;
                String sql = String.format("DELETE FROM diaryTB WHERE data2 = '%s'", diary_content);
    ...
    public void modifyData(View v) {
        ...
        String msg = nowData + "";
        it.putExtra("it_name", msg);  //key 와 value로 담아져서 간다.
